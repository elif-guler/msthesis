...
Unchanged from the original gin_mge version - BLASTing markers against
a reference FASTA works identically regardless of which strain or
marker set (fur/seqwin) is fed in.
"""
import sys
import subprocess
